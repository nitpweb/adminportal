...
import { AddForm } from "./project-props/add-form";
import { EditForm } from "./project-props/edit-form";
	...
	return (
		<div>
			...
			<Grid container spacing={3} className={classes.root}>
				{details.project && details.projects.map((detail) => {
					...
					return (
						<React.Fragment key={detail.id}>
							<Grid item xs={12} sm={10} lg={11}>
								...
								>
									<span className={classes.truncate}>{detail.project}</span>
								</Paper>
							</Grid>
