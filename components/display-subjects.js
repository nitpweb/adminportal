...
import { AddForm } from "./subjects_teaching-props/add-form";
import { EditForm } from "./subjects_teaching-props/edit-form";
	...
	return (
		<div>
			...
			<Grid container spacing={3} className={classes.root}>
				{details.subjects_teaching && details.subjects.map((detail) => {
					...
					return (
						<React.Fragment key={detail.id}>
							<Grid item xs={12} sm={10} lg={11}>
								...
								>
									<span className={classes.truncate}>{detail.subjects}</span>
								</Paper>
							</Grid>
