...
import { AddForm } from "./workexperience-props/add-form";
import { EditForm } from "./workexperience-props/edit-form";
	...
	return (
		<div>
			...
			<Grid container spacing={3} className={classes.root}>
				{details.work_experience && details.workExperience.map((detail) => {
					...
					return (
						<React.Fragment key={detail.id}>
							<Grid item xs={12} sm={10} lg={11}>
								...
								>
									<span className={classes.truncate}>{detail.work_experiences}</span>
								</Paper>
							</Grid>
