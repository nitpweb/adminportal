...
import { AddForm } from "./professional_service-props/add-form";
import { EditForm } from "./professional_service-props/edit-form";
	...
	return (
		<div>
			...
			<Grid container spacing={3} className={classes.root}>
				{details.professional_service && details.services.map((detail) => {
					...
					return (
						<React.Fragment key={detail.id}>
							<Grid item xs={12} sm={10} lg={11}>
								...
								>
									<span className={classes.truncate}>{detail.services}</span>
								</Paper>
							</Grid>
