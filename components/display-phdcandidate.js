...
import { AddForm } from "./phd_candidates-props/add-form";
import { EditForm } from "./phd_candidates-props/edit-form";
	...
	return (
		<div>
            ...
            <tr>
				...
				{details.phd_candidates && details.phdCandidates.map((detail) => {
					...
					return (
						<React.Fragment key={detail.id}>
                            <tr>
                                <td>{detail.phd_student_name}</td>
                                <td>{detail.thesis_topic}</td>
                                <td>{detail.start_year}</td>
                                <td>{detail.completion_year}</td>
                                <td><Paper
