        ...
        if (type == "image") {
          ...
          let result = await query(
            `INSERT INTO education (id,email,certification,institution,passing_year) VALUES` +
              `(${params.id},'${params.email}','${params.certification}','${params.institution}','${params.passing_year}')`
          );
          res.json(result);
          ...
          let result = await query(
            `INSERT INTO phd_candidates (id,email,phd_student_name,thesis_topic,start_year,completion_year) VALUES` +
              `(${params.id},'${params.email}','${params.phd_student_name}','${params.thesis_topic}','${params.start_year}','${params.completion_year}')`
          );
          res.json(result);
        }
      } else {
